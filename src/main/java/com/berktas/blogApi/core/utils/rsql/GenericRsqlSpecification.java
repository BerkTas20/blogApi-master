package com.berktas.blogApi.core.utils.rsql;
...
public class GenericRsqlSpecification<T> implements Specification<T> {
    ...
    // https://github.com/jirutka/rsql-parser/issues/29
    ...
    private List<Object> castArguments(Path<?> propertyExpression) {
        ...
        List<Object> result = arguments.stream().map(arg -> {
            ...
            else if (Enum.class.isAssignableFrom(type)) return Enum.valueOf(type, arg);
            else return arg;
